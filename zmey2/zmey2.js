...
let apples=0;	let appleImageSrc= 'url("img/apple.gif")';
let keyRepeat=false;	//false	- no repeat		
...
function hereApple(xPos,yPos){	let position=checkPos(xPos,yPos); 
...
function resolve(p){ if (p) {if (xPos>10) {direction='Left';} else {direction='Right';}}	//resolve x
	    	     else   {if (yPos>10) {direction='Up';}   else {direction='Down';}}	//resolve y
